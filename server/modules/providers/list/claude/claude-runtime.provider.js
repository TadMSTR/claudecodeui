...
} from '@/shared/argv-secret-guard.js';
import {
  appendFilesInputTag,
...
async function queryClaudeSDK(command, options = {}, ws, context) {
  ...
  try {
    ...
    // Placed after mcpServers/allowedTools are final and before either query()
    // call site, so it covers the hooks-failure retry as well as the first try.
